...
namespace BulkyBookWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details_PayNow()
        {
            ...
            {
                var sessionLionItem = new SessionLineItemOptions
                {
                ...
                options.LineItems.Add(sessionLionItem);
            }
        ...
        public IActionResult GetAll(string status)
        {
            ...
            //admin and emploee account can see all orders, others can only see their own orders
